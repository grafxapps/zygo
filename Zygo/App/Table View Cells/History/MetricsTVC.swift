...
class MetricsTVC: UITableViewCell {
    
    static let identifier = "MetricsTVC"
...
extension MetricsTVC: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout{
