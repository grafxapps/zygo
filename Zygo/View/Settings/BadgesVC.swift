...
class BadgesVC: UIViewController {
    ...
    var itemInfo = IndicatorInfo(title: "BADGES")
...
extension BadgesVC : UITableViewDataSource, UITableViewDelegate{
    func numberOfSections(in tableView: UITableView) -> Int {
        return self.viewModel.arrBadges.count
    }
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        let item = self.viewModel.arrBadges[section]
        switch item {
        case .classCount:
            return 1
        case .Achievements:
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let item = self.viewModel.arrBadges[indexPath.section]
        switch item {
        case .classCount:
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        case .classCount:
            return 70.0
        case .Achievements:
            return ScreenSize.SCREEN_HEIGHT - (UIApplication.statuBarFrame().height + 180 + UIApplication.BottomSpace() + 10 + 45 + 70)
        case .WorkoutLogs:
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let itemH = self.viewModel.arrBadges[indexPath.section]
...
extension BadgesVC : IndicatorInfoProvider, AchievementsTVCDelegates{
    func didSelect(achievement: AchievementDTO) {
        ...
        Helper.shared.topNavigationController()?.pushViewController(achiVC, animated: true)
    }
