//
//  CountingLapsAnimationVC.swift
//  Zygo
//
//  Created by Som Parkash on 07/06/23.
...
class CountingLapsAnimationVC: UIViewController {
    ...
    func setupRestartAnimation(){
        UIView.animate(withDuration: 1) {
            ...
            UIView.animate(withDuration: 1.5) {
                self.lblPressAndHoldMinus.alpha = 1.0
                
                self.headset4VerticalImageView.alpha = 1.0

                self.headset4VerticalHeightConstraint.constant = self.headsetVerticalImageView.frame.size.height
...
extension CountingLapsAnimationVC: UIScrollViewDelegate{
...
//MARK: - Player
extension CountingLapsAnimationVC{
...
enum CountingLapsSound: String{
    case on = "originallapon"
    case off = "originallapoff"
}
